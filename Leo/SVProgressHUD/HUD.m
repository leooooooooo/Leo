...
+ (void)showImage:(UIImage *)image status:(NSString *)string {
    NSTimeInterval displayInterval = [[HUD sharedView] displayDurationForString:string];
...
- (UIImage *)hudSuccessImage {
    ...
    return [UIImage imageNamed:@"HUD.bundle/success.png"];
}
...
- (UIImage *)hudErrorImage {
    ...
    return [UIImage imageNamed:@"HUD.bundle/error.png"];
}
